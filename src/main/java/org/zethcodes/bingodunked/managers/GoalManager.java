...
public class GoalManager {
    ...
    public Goal testGoal = null;

    public void ClearGoals()
    {
        availableGoals.clear();
        biomeGoals.clear();
        structureGoals.clear();
    }

    public void SetStructureGoals()
    {
        ItemStack heartOfTheSea = new ItemStack(Material.HEART_OF_THE_SEA, 1);
        CollectItemGoal heartOfTheSeaGoal = new CollectItemGoal("Collect a Heart of the Sea from the Buried Treasure", heartOfTheSea);
        structureGoals.put(Structure.BURIED_TREASURE, heartOfTheSeaGoal);

        ItemStack breezeRod = new ItemStack(Material.BREEZE_ROD, 1);
        KillEntityGoal killBreezeGoal = new KillEntityGoal("Kill a Breeze in the Trial Chambers", breezeRod, EntityType.BREEZE, GameManager.instance.killEntityListener);
        structureGoals.put(Structure.TRIAL_CHAMBERS, killBreezeGoal);

        ItemStack cobweb = new ItemStack(Material.COBWEB, 32);
        CollectItemsAmountGoal cobwebGoal = new CollectItemsAmountGoal("Collect 32 Cobwebs from the Mineshaft", cobweb);
        structureGoals.put(Structure.MINESHAFT, cobwebGoal);

        ItemStack emeraldBlock = new ItemStack(Material.EMERALD_BLOCK, 1);
        CollectItemGoal emeraldBlockGoal = new CollectItemGoal("Craft an Emerald Block at the Village", emeraldBlock);
        structureGoals.put(Structure.VILLAGE_TAIGA, emeraldBlockGoal);

        ItemStack sculkSensor = new ItemStack(Material.SCULK_SENSOR,1);
        CompleteAdvancementGoal sneakGoal = new CompleteAdvancementGoal("Complete the advancement Sneak 100 in the Ancient City", sculkSensor, Bukkit.getAdvancement(new NamespacedKey("minecraft","adventure/avoid_vibration")));
        structureGoals.put(Structure.ANCIENT_CITY, sneakGoal);

        ItemStack elderGuardianEgg = new ItemStack(Material.ELDER_GUARDIAN_SPAWN_EGG,1);
        KillEntityGoal elderGuardianKillGoal = new KillEntityGoal("Kill an Elder Guardian in the Monument", elderGuardianEgg, EntityType.GUARDIAN,GameManager.instance.killEntityListener);
        structureGoals.put(Structure.MONUMENT,elderGuardianKillGoal);

        ItemStack bell = new ItemStack(Material.BELL, 1);
        CollectItemGoal bellGoal = new CollectItemGoal("Collect a Bell from the Village", bell);
        structureGoals.put(Structure.VILLAGE_PLAINS, bellGoal);

        ItemStack rabbitStew = new ItemStack(Material.RABBIT_STEW, 1);
        EatGoal rabbitStewGoal = new EatGoal("Eat some Rabbit Stew at the Village", rabbitStew, GameManager.instance.eatListener);
        structureGoals.put(Structure.VILLAGE_SNOWY, rabbitStewGoal);

        ItemStack rawCod = new ItemStack(Material.COD,1);
        BreedEntityGoal catBreedGoal = new BreedEntityGoal("Breed two Cats from the Village", rawCod, EntityType.CAT, GameManager.instance.breedEntityListener);
        structureGoals.put(Structure.VILLAGE_DESERT, catBreedGoal);
        ...
        CollectItemsGoal chainmailArmorGoal = new CollectItemsGoal("Collect any piece of Chainmail Armor from the Village", chainmailArmors);
        structureGoals.put(Structure.VILLAGE_SAVANNA, chainmailArmorGoal);

        ItemStack mossyStone = new ItemStack(Material.MOSSY_COBBLESTONE, 32);
        CollectItemsAmountGoal mossyCobbleGoal = new CollectItemsAmountGoal("Collect 32 Mossy Cobblestone from the Jungle Pyramid", mossyStone);
        structureGoals.put(Structure.JUNGLE_PYRAMID, mossyCobbleGoal);

        ItemStack pillagerEgg = new ItemStack(Material.PILLAGER_SPAWN_EGG, 1);
        KillEntityGoal killPillagerGoal = new KillEntityGoal("Kill a Pillager at the Outpost", pillagerEgg, EntityType.PILLAGER, GameManager.instance.killEntityListener);
        structureGoals.put(Structure.PILLAGER_OUTPOST, killPillagerGoal);

        ItemStack poisonousPotato = new ItemStack(Material.POISONOUS_POTATO, 1);
        EatGoal eatPoisonousPotato = new EatGoal("Eat a Poisonous Potato from in the Shipwreck", poisonousPotato, GameManager.instance.eatListener);
        structureGoals.put(Structure.SHIPWRECK, eatPoisonousPotato);
    }
...
//        biomeGoals.put(Biome.DEEP_FROZEN_OCEAN,seaLanternGoal);
        ...
        ItemStack coarsedirt = new ItemStack(Material.COARSE_DIRT, 32);
        CollectItemsAmountGoal coarseDirtGoal = new CollectItemsAmountGoal("Collect 32 Coarse Dirt Blocks", coarsedirt);
...
//        DeathGoal berryPokedGoal = new DeathGoal("Achieve the Death Message '<player> was poked to death by a sweet berry bush'",berries,"was poked to death by a sweet berry bush",GameManager.instance.deathListener);
//        biomeGoals.put(Biome.TAIGA,berryPokedGoal);
    ...
    public void AddGoals(int stage)
    {
        ...
        if (stage == 0)
        {
            ...
            strippedLogsMaterials.add(Material.STRIPPED_PALE_OAK_LOG);
            CollectItemsAmountGoal strippedLogsGoal = new CollectItemsAmountGoal("Collect 32 Stripped Logs of Any Variant", strippedLogsMaterials, 32);
            ...
            CollectItemsGoal harnessGoal = new CollectItemsGoal("Craft any Harness", harnesses);
            availableGoals.add(harnessGoal);

            ItemStack woodenSword = new ItemStack(Material.WOODEN_SWORD, 1);
            CompleteNumberAdvancementGoal advancements10Goal = new CompleteNumberAdvancementGoal("Collect 10 Advancements", woodenSword, 10, GameManager.instance.advancementListener);
            availableGoals.add(advancements10Goal);

            ItemStack lightGrayBanner = new ItemStack(Material.LIGHT_GRAY_BANNER, 1);
            CollectColouredItemGoal lightGrayBannerGoal = new CollectColouredItemGoal("Craft a Light Gray Banner", lightGrayBanner);
            availableGoals.add(lightGrayBannerGoal);

            ItemStack lightGrayConcrete = new ItemStack(Material.LIGHT_GRAY_CONCRETE, 1);
            CollectColouredItemGoal lightGrayConcreteGoal = new CollectColouredItemGoal("Collect a Block of Light Gray Concrete", lightGrayConcrete);
            availableGoals.add(lightGrayConcreteGoal);

            ItemStack lightGrayGlass = new ItemStack(Material.LIGHT_GRAY_STAINED_GLASS, 1);
            CollectColouredItemGoal lightGrayGlassGoal = new CollectColouredItemGoal("Collect a Block of Light Gray Stained Glass", lightGrayGlass);
            availableGoals.add(lightGrayGlassGoal);
            ...
            ItemStack orangeStainedGlass = new ItemStack(Material.ORANGE_STAINED_GLASS, 1);
            CollectColouredItemGoal orangeGlassGoal = new CollectColouredItemGoal("Collect a Block of Orange Stained Glass", orangeStainedGlass);
            availableGoals.add(orangeGlassGoal);

            ItemStack purpleBanner = new ItemStack(Material.PURPLE_BANNER, 1);
            CollectColouredItemGoal purpleBannerGoal = new CollectColouredItemGoal("Craft a Purple Banner", purpleBanner);
            availableGoals.add(purpleBannerGoal);

            ItemStack purpleConcrete = new ItemStack(Material.PURPLE_CONCRETE, 1);
            CollectColouredItemGoal purpleConcreteGoal = new CollectColouredItemGoal("Collect a Block of Purple Concrete", purpleConcrete);
            availableGoals.add(purpleConcreteGoal);

            ItemStack purpleGlass = new ItemStack(Material.PURPLE_STAINED_GLASS, 1);
            CollectColouredItemGoal purpleGlassGoal = new CollectColouredItemGoal("Collect a Block of Purple Stained Glass", purpleGlass);
            availableGoals.add(purpleGlassGoal);
        } else if (stage == 1)
        {
            ...
            TravelGoal run1000Goal = new TravelGoal("Run 1000 Blocks", goldBoots, 1000.0, TravelListener.TYPE.RUNNING, GameManager.instance.travelListener);
            availableGoals.add(run1000Goal);
            ...
            CauldronInteractGoal fillCauldronGoal = new CauldronInteractGoal("Fill a Cauldron", cauldron, 3, GameManager.instance.cauldronListener);
            availableGoals.add(fillCauldronGoal);

            ItemStack stoneSword = new ItemStack(Material.STONE_SWORD, 1);
            CompleteNumberAdvancementGoal advancements20Goal = new CompleteNumberAdvancementGoal("Collect 20 Advancements", stoneSword, 20, GameManager.instance.advancementListener);
            availableGoals.add(advancements20Goal);
        ...
        } else if (stage == 2)
        {
            ...
            CompleteNumberAdvancementGoal advancements30Goal = new CompleteNumberAdvancementGoal("Collect 30 Advancements", ironSword, 30, GameManager.instance.advancementListener);
            availableGoals.add(advancements30Goal);

            List<Material> concretes = new ArrayList<>();
            concretes.add(Material.WHITE_CONCRETE);
            concretes.add(Material.LIGHT_GRAY_CONCRETE);
            concretes.add(Material.GRAY_CONCRETE);
            concretes.add(Material.BLACK_CONCRETE);
            concretes.add(Material.BROWN_CONCRETE);
            concretes.add(Material.RED_CONCRETE);
            concretes.add(Material.ORANGE_CONCRETE);
            concretes.add(Material.YELLOW_CONCRETE);
            concretes.add(Material.LIME_CONCRETE);
            concretes.add(Material.GREEN_CONCRETE);
            concretes.add(Material.CYAN_CONCRETE);
            concretes.add(Material.LIGHT_BLUE_CONCRETE);
            concretes.add(Material.BLUE_CONCRETE);
            concretes.add(Material.PURPLE_CONCRETE);
            concretes.add(Material.MAGENTA_CONCRETE);
            concretes.add(Material.PINK_CONCRETE);
            CollectItemSetAmountGoal diffConcretesGoal = new CollectItemSetAmountGoal("Collect 8 Different Types of Concrete", concretes, 8);
            availableGoals.add(diffConcretesGoal);
        } else if (stage == 3)
        {
            ...
            ItemStack tuffBricks = new ItemStack(Material.TUFF, 64);
            CollectItemsAmountGoal tuffBricksGoal = new CollectItemsAmountGoal("Collect 64 Tuff Bricks", tuffBricks);
            ...
            CollectItemsAmountGoal obsidianGoal = new CollectItemsAmountGoal("Collect 32 Obsidian", obsidian);
            availableGoals.add(obsidianGoal);

            ItemStack enchantingTable = new ItemStack(Material.ENCHANTING_TABLE, 1);
            CollectItemGoal enchantingTableGoal = new CollectItemGoal("Collect an Enchanting Table", enchantingTable);
            availableGoals.add(enchantingTableGoal);

            ItemStack jukebox = new ItemStack(Material.JUKEBOX, 1);
            CollectItemGoal jukeboxGoal = new CollectItemGoal("Craft a Jukebox", jukebox);
            availableGoals.add(jukeboxGoal);

            ItemStack lapis = new ItemStack(Material.LAPIS_LAZULI, 64);
            CollectItemsAmountGoal lapisGoal = new CollectItemsAmountGoal("Collect 64 Lapis Lazuli", lapis);
            availableGoals.add(lapisGoal);

            ItemStack copperGrate = new ItemStack(Material.COPPER_GRATE, 64);
            CollectItemsAmountGoal copperGrateGoal = new CollectItemsAmountGoal("Collect 64 Copper Grates", copperGrate);
            availableGoals.add(copperGrateGoal);
            ...
            TravelGoal boat5000Goal = new TravelGoal("Use a Boat to travel 5000 Blocks", boat, 5000.0, TravelListener.TYPE.BOAT, GameManager.instance.travelListener);
            availableGoals.add(boat5000Goal);

            TravelGoal pig100Goal = new TravelGoal("Use a Pig to travel 250 Blocks",saddle,250.0,TravelListener.TYPE.PIG,GameManager.instance.travelListener);
            availableGoals.add(pig100Goal);

            TravelGoal horse1000Goal = new TravelGoal("Use a Horse to travel 1000 Blocks", saddle, 1000.0, TravelListener.TYPE.HORSE, GameManager.instance.travelListener);
            availableGoals.add(horse1000Goal);

            TravelGoal strider250Goal = new TravelGoal("Use a Strider to travel 250 Blocks", striderSaddle, 250.0, TravelListener.TYPE.STRIDER, GameManager.instance.travelListener);
            availableGoals.add(strider250Goal);
            ...
            CompleteAdvancementGoal driedGhastGoal = new CompleteAdvancementGoal("Complete the advancement 'Stay Hydrated!'", driedGhast, Bukkit.getAdvancement(new NamespacedKey("minecraft","husbandry/place_dried_ghast_in_water")));
            availableGoals.add(driedGhastGoal);

            ItemStack diamondSword = new ItemStack(Material.DIAMOND_SWORD, 1);
            CompleteNumberAdvancementGoal advancements40Goal = new CompleteNumberAdvancementGoal("Collect 40 Advancements", diamondSword, 40, GameManager.instance.advancementListener);
            availableGoals.add(advancements40Goal);
        } else if (stage == 4)
        {
            ...
            CompleteNumberAdvancementGoal advancements50Goal = new CompleteNumberAdvancementGoal("Collect 50 Advancements", netheriteSword, 50, GameManager.instance.advancementListener);
            availableGoals.add(advancements50Goal);
        } else
        {
            AddGoals(2);
            AddGoals(3);
